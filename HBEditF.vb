...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.EditB.Location = New System.Drawing.Point(160, 184)
        Me.EditB.Name = "EditB"
        Me.EditB.Size = New System.Drawing.Size(96, 23)
        Me.EditB.TabIndex = 5
        Me.EditB.Text = "ذخیره پرداخت"
        '
        'ChangeB
        '
        ...
        Me.TarikheBardasht.TabIndex = 44
        ...
        'ID
        '
        Me.ID.Location = New System.Drawing.Point(0, 200)
        Me.ID.Name = "ID"
...
#End Region
    ...
    Private Sub HBEditF_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadKeyboardLayout("00000429", 1)
        Try
            DBConn = New DBConnection
            DBConn.connectMe("SELECT * FROM HBList WHERE ID=" & ID.Text & ";")
            Try
                DBConn.OLEComm.Connection = DBConn.OLEConn
                Dim d As OleDb.OleDbDataReader = DBConn.OLEComm.ExecuteReader()
                Do While d.Read
                    Pardakhter.Text = d("Pardakhter".ToString)
                    Tell.Text = d("Tell".ToString)
                    ForSub.Text = d("ForSub".ToString)
                    MablagheBardasht.Text = d("Mablagh".ToString)
                    TarikheBardasht.Text = d("Tarikh".ToString)
                Loop
                Try
    ...
    Private Sub HBEditF_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    ...
    Private Sub EditB_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EditB.Click
        ...
        Try
            DBConn = New DBConnection
            DBConn.connectMe("Update HBList SET Pardakhter='" & Pardakhter.Text & "',Tell='" & Tell.Text & "',ForSub='" & ForSub.Text & "',Mablagh='" & MablagheBardasht.Text & "',Tarikh='" & TarikheBardasht.Text & "' WHERE ID=" & ID.Text & ";")
            DBConn.OLEComm.Connection = DBConn.OLEConn
